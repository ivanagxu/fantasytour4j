...
public class NpcCreaterFrame extends JFrame{
		...
		openitem.addActionListener(new 
				ActionListener()
				{
					public void actionPerformed(ActionEvent event)
					{
						...
						int result = chooser.showOpenDialog(NpcCreaterFrame.this);
						if(result == 0)
						{
