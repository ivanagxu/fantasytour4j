...
public class CreaterFrame extends JFrame{
	/**
	 * 
	 */
	private static final long serialVersionUID = -473138844883804386L;
	public CreaterFrame()
	{
		...
		openitem.addActionListener(new 
				ActionListener()
				{
					public void actionPerformed(ActionEvent event)
					{
						...
						int result = chooser.showOpenDialog(CreaterFrame.this);
						if(result == 0)
						{
